...
const PrimeiroPasso = ({ formData, onNext, onFormChange }) => {
  ...
  const aProsseguir = () => {
    ...
    formData.nome === "" &&
      mensagensErro.push("O campo nome não pode estar nulo ou vazio!");
    formData.cnpj === "" &&
      mensagensErro.push("O campo do CNPJ não pode estar nulo ou vazio!");
    formData.razaoSocial === "" &&
      mensagensErro.push(
        "O campo de nome da Razão Social não pode estar nulo ou vazio!"
      );
      ...
      <form>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            onChange={(e) => handleChange("razaoSocial", e)}
            className="mt-1 p-2 w-full border rounded-md"
