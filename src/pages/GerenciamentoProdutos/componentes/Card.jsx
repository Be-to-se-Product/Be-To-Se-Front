  ...
  return (
    <div className="w-[180px]   bg-white-principal p-4 flex flex-col gap-4 rounded-md ">
      ...
      <div className="content-text flex flex-col gap-2">
        ...
        <Button className="w-full" onClick={()=>openModal("update",produto.id)}>Editar Produto</Button>
        <Button className="w-full bg-red-500 text-white-principal" onClick={()=>openModal("delete",produto.id)}>Deletar Produto</Button> 
      </div>
