      ...
      <div className="h-[150px] rounded-md  ">
        ...
        <div className=" flex flex-col justify-content align-center gap-[20px] self-stretch">
          ...
          <div className="flex gap-auto flex-col justify-between items-start">
            <div className="">
              <p className="line-through">R$ {produto?.precoAntigo}</p>
            </div>

            <div className="">
              <p className="text-4xl font-medium">
                R${" "}
                {produto?.precoAtual ? produto.precoAtual : produto.precoAntigo}
              </p>
            </div>
          ...
          <div className="text-sm  size-8 gap-8 flex justify-center align-center">
            ...
            <p>{conversorTime(produto?.estabelecimento?.tempoPessoa)}</p>

            <p>{conversorTime(produto?.estabelecimento?.tempoBike)}</p>
          </div>
        </div>
      </div>
    </div>
