    ...
    <div className="flex flex-row">
      ...
      >
        <div style={{ display: showPaymentMoment ? "block" : "none" }}>
          <div
            id="momento_pagamento"
            className="flex flex-col mt-20 w-full items-center gap-y-14"
          >
            <h2 className="text-2xl">
              Em que momento você quer pagar pelo pedido?
            </h2>
            <div className="flex flex-col gap-y-6 w-full items-center ">
              ...
              <div className="flex flex-row px-8 py-2 gap-x-6 bg-black-100 w-full rounded-lg">
                <input
                  ...
                  onChange={() =>
                    handleOptionChange("pagamentoNoEstabelecimento")
                  }
                />
            ...
            <button
              className="bg-orange-principal py-2 px-4 h-max text-base font-medium rounded-lg w-52"
        ...
        <div style={{ display: showMetodosAceito ? "block" : "none" }}>
          ...
          >
            <h2 className="text-2xl">
              Métodos de pagamento acieto no estabelecimento
            </h2>
            <div
              className="flex flex-row gap-y-6 w-full items-center justify-center gap-3 flex-wrap"
              style={{
                maxWidth: "800px",
                maxHeight: "200px",
                overflow: "auto",
            ...
            <div className="flex flex-row gap-x-8">
              <button
                className="bg-orange_opacity-principal py-2 px-4 h-max text-base font-medium rounded-lg w-52"
                onClick={handleBack}
              >
                Voltar
              </button>
        ...
        >
          <div className=" flex flex-col mt-20 w-full items-center gap-y-14">
            ...
            <div className="flex flex-col gap-y-4">
              <button
                className="bg-orange-principal py-2 px-8 h-max text-base font-medium rounded-lg"
                onClick={() => navigate("/usuario/pedidos")}
              >
                Acompanhar o pedido
              </button>
              <button
                className="py-2 text-xs font-medium text-blue-900"
      ...
      <div
        id="overlay"
        style={{ ...overlayStyle, display: showDivOverlay ? "flex" : "none" }}
        className="flex flex-col items-center"
      >
        <div className="flex flex-row py-8" style={innerContainerStyle}>
          <button
            className="bg-orange-principal py-2 px-4 h-max text-base font-medium rounded-lg"
            onClick={() => navigate(`/index`)}
          >
            Cancelar compra
          </button>
          <div className="flex flex-col items-center transform -translate-y-2/3">
            <button
              id="up_down"
              className="h-16 w-16 bg-orange-principal rounded-full flex items-center justify-center border-2 border-slate-950"
              onClick={() => {
