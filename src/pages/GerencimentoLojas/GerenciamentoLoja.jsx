...
import CardRoot from "@componentes/Card/CardRoot";
...
const GerenciamentoLoja = () => {
  ...
  const [isVisibleModalDelete, setIsVisibleModalDelete] = useState({
    open: false,
    id: "",
  });
  ...
  return (
    <>
      <main className="flex bg-[#EAEAEA]">
        ...
        <Modal isVisible={isVisibleModalDelete.open}>
          <div className="bg-white-principal px-10 py-8 flex flex-col gap-y-8 rounded-sm">
            ...
            <div className="content-button w-full flex gap-x-4 justify-center">
              <Button
                ...
                onClick={() => setIsVisibleModalDelete({ open: false, id: "" })}
              >
                Cancelar
              </Button>
              ...
              <Button
                ...
                onClick={() => {
                  deleteByLoja(isVisibleModalDelete.id);
                }}
              >
                Sim
              </Button>
